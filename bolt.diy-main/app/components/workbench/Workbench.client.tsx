                ...
                <div className="flex items-center px-3 py-2 border-b border-bolt-elements-borderColor gap-1.5">
                  ...
                  {selectedView === 'code' && (
                    <div className="flex overflow-y-auto">
                      {/* Removed Export Chat Button and Sync Button - Agent mode doesn't need these */}

                      {/* Deploy Button */}
                      <div className="flex border border-bolt-elements-borderColor rounded-md overflow-hidden ml-1">
                        <button
                          onClick={() => {
                            // Deploy functionality - can be customized for your needs
                            console.log('Deploy clicked');
                          }}
                          className="rounded-md items-center justify-center [&:is(:disabled,.disabled)]:cursor-not-allowed [&:is(:disabled,.disabled)]:opacity-60 px-3 py-1.5 text-xs bg-green-600 text-white hover:bg-green-700 outline-green-600 flex gap-1.7"
                        >
